...
<body>
	...
	<div class="row-fluid sortable ui-sortable">
		...
		<div class="box span4">
			...
			<div class="box-content">
				<div id="realtimechart" style="height: 190px; padding: 0px; position: relative;"><canvas class="base" width="292" height="190"></canvas><canvas class="overlay" width="292" height="190" style="position: absolute; left: 0px; top: 0px;"></canvas><div class="tickLabels" style="font-size:smaller"><div class="yAxis y1Axis" style="color:#545454"><div class="tickLabel" style="position:absolute;text-align:right;top:177px;right:274px;width:18px">0</div><div class="tickLabel" style="position:absolute;text-align:right;top:132px;right:274px;width:18px">25</div><div class="tickLabel" style="position:absolute;text-align:right;top:86px;right:274px;width:18px">50</div><div class="tickLabel" style="position:absolute;text-align:right;top:41px;right:274px;width:18px">75</div><div class="tickLabel" style="position:absolute;text-align:right;top:-5px;right:274px;width:18px">100</div></div></div></div>
