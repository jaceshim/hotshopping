$(document).ready(function(){
	...
	{
		$('#bs-css').attr('href','/static/ui/css/bootstrap-'+theme_name+'.css');
	}
...
function docReady(){
	...
	var elf = $('.file-manager').elfinder({
		url : '/static/ui/misc/elfinder-connector/connector.php'  // connector URL (REQUIRED)
	}).elfinder('instance');
	...
	$('#file_upload').uploadify({
		'swf'      : '/static/ui/misc/uploadify.swf',
		'uploader' : '/static/ui/misc/uploadify.php'
